        ...
        if usr_cmd == "/start":
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/+y3URnRGyizQ3MmM1"),
                            InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/TeluguZone0")
                        ],
                        [
                        ...
                        [
                            InlineKeyboardButton("⎝⎝✧✧ BACKUP ✧✧⎠⎠", url="https://t.me/TeluguZoneOFC")
                        ]]))
            else :
                await cmd.reply_photo(photo=lazy_pic,
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/+y3URnRGyizQ3MmM1"),
                            InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/TeluguZone0")
                        ],
                        [
                            InlineKeyboardButton("🤖Aß⊕ut ß⊕t", callback_data="aboutbot"),
                            InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="aboutdevs")
            ...
            if Config.UPDATES_CHANNEL:
                ...
                try:
                    ...
                    if user.status == "kicked":
                        await cmd.message.edit(
                            text="ꜱᴏʀʀʏ ꜱɪʀ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ᴛᴏ ᴜꜱᴇ ᴍᴇ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/TeluguZoneOFC).",
                            disable_web_page_preview=True
                        )
                        return
